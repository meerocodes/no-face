        ...
        <div className="aboutPage">
            <div className="wrapper">
                ...
                <Link to='/preOrder'><img src={logo3d}  className='aboutLogo' alt ='no face logo 3d render gif'></img></Link>
                    <h2><span id='founded'>F</span>ounded in November 2019, <span>NOFACECLUB </span>  is a collective of visionary minds driven by a singular purpose: to stand the f*ck out. We
